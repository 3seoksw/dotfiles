# Generated by Powerlevel10k configuration wizard on 2023-11-18 at 18:50 KST.
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='KWS'
  ...
  function prompt_my_extra_icon() {
    # Apple logo
    #p10k segment -t '%F{yellow}KWS%F{red}@'$'%F{white}\ue711:'
    # Penguin \uF17C
    p10k segment -t '%F{grey}KWS%F{red}@'$'%F{yellow}\uF17C:'
  }
